...
function Scr_check_weapon() {	/// @DnDAction : YoYo Games.Common.If_Variable
	...
	with(O_QuickInvent_manager) var l283A787A_0 = weapons == noone;
	if(!l283A787A_0){	/// @DnDAction : YoYo Games.Instances.Create_Instance
		...
		/// @DnDArgument : "objectid" "weapons"
		/// @DnDArgument : "layer" ""object""
		with(O_QuickInvent_manager) {
			instance_create_layer(O_character.x - 8, O_character.y - 16, "object", weapons); 
		}}}